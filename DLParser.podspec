#
#  Be sure to run `pod spec lint DLParser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "ajohnson"
  # s.authors            = { "ajohnson" => "ajohnson388@gmail.com" }
  # s.social_media_url   = "http://twitter.com/ajohnson"
