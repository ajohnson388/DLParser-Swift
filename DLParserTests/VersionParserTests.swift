 ...
 */
final class VersionParserTests {
    
    private func testVersionParser(mockLicense: DriverLicense, licenseDataString: String) {
        let actualLicense = AAMVAParser(data: licenseDataString).parse()
        assert(mockLicense == actualLicense)
    }
